                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="pais" id="pais" class="form-control @error('pais') is-invalid @enderror" name="pais" value="{{ old('pais') }}" autocomplete="pais" @change="onChange()" required></select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                <br>
                            <div class="alert alert-info" style="font-size: 10px" role="alert">
                                <strong>
